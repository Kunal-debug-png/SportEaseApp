...
import com.allandroidprojects.ecomsample.startup.MyOrder;
import com.allandroidprojects.ecomsample.startup.Registration;
...
public class ItemDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            itemDesc = (TextView) findViewById(R.id.search_name);
        ...
        textViewBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i = new Intent(ItemDetailsActivity.this, MyOrder.class);
                startActivity(i);

            }
        });

        TextView btn_share = (TextView) findViewById(R.id.text_action1);
        ...
        TextView txt_wish = (TextView) findViewById(R.id.text_action3);
        txt_wish.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                i1 = new Intent(ItemDetailsActivity.this, WishlistActivity.class);
                startActivity(i1);
            }
        });

        TextView txt_rate = (TextView) findViewById(R.id.text_action2);
        txt_rate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                i2 = new Intent(ItemDetailsActivity.this, ProductRating.class);
                startActivity(i2);
            }
        });
    }
